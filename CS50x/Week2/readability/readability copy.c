...
int main(void)
{
    ...
    printf("%i letters\n", letter_count); //-----------------------------------------------PRINTF CHECKPOINT - letter count
    int word_count = count_words(text);
    printf("%i words\n", word_count); //---------------------------------------------------PRINTF CHECKPOINT - word count
    int sentence_count = count_sentences(text);
    printf("%i sentences\n", sentence_count); //-------------------------------------------PRINTF CHECKPOINT - sentence count
    ...
    printf("L = %f\n", L); //--------------------------------------------------------------PRINTF CHECKPOINT - letters / words

    float S = (((float)sentence_count / (float)word_count) * 100);
    printf("S = %f\n", S); //--------------------------------------------------------------PRINTF CHECKPOINT - letters / words

    float index = ((0.0588 * L) - (0.296 * S));
    index = (index - 15.8);
    index = round(index);
    printf("Index = %i\n", (int)index); //-----------------------------------------------------PRINTF CHECKPOINT - Index Value rounded
